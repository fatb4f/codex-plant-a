...
## Contract
- Contract path: `$CODEX_HOME/ctrlex/packets/<area>/<packet_id>/contract.json`

## Execution location
- Worktree root: `$CODEX_HOME/ctrlex/worktrees/<packet_id>/`
...
## Evidence
Required artifacts under `$CODEX_HOME/ctrlex/out/<packet_id>/`:
- `summary.md`
- `raw/diffstat.txt`
